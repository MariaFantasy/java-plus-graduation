...
public interface EventDtoMapper {
    ...
    @Mapping(target = "state", expression = "java(ru.yandex.practicum.dto.EventState.PENDING)")
    ...
    @Mapping(target = "state", expression = "java((eventDto.getStateAction() != null && eventDto.getStateAction().equals(ru.yandex.practicum.dto.EventStateAction.SEND_TO_REVIEW)) ? ru.yandex.practicum.dto.EventState.PENDING : ru.yandex.practicum.dto.EventState.CANCELED)")
    @Mapping(target = "eventDate", source = "eventDate", dateFormat = "yyyy-MM-dd HH:mm:ss")
    ...
    @Mapping(target = "initiatorId", ignore = true)
    @Mapping(target = "confirmedRequests", ignore = true)
    @Mapping(target = "state", expression = "java((eventDto.getStateAction() != null && eventDto.getStateAction().equals(ru.yandex.practicum.dto.EventStateAction.PUBLISH_EVENT)) ? ru.yandex.practicum.dto.EventState.PUBLISHED : ru.yandex.practicum.dto.EventState.CANCELED)")
    @Mapping(target = "eventDate", source = "eventDate", dateFormat = "yyyy-MM-dd HH:mm:ss")
    @Mapping(target = "createdOn", ignore = true)
    @Mapping(target = "publishedOn", ignore = true)
    @Mapping(target = "views", ignore = true)
