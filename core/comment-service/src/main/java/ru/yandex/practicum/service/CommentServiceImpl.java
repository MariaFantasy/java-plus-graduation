...
import ru.yandex.practicum.feign.client.EventClient;
import ru.yandex.practicum.feign.client.UserClient;
import ru.yandex.practicum.mapper.CommentDtoMapper;
import ru.yandex.practicum.model.Comment;
import ru.yandex.practicum.storage.CommentRepository;
...
public class CommentServiceImpl implements CommentService {
    ...
    public CommentDto create(Long userId, NewCommentDto commentDto) {
        final UserShortDto userDto = userClient.getById(userId);
        final EventFullDto eventDto = eventClient.getById(commentDto.getEvent());
